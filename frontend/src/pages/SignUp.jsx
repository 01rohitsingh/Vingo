    ...
    <div className='min-h-screen w-full flex items-center justify-center p-4' style={{ backgroundColor: bgColor }}>
      <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px]`} style={{ border: `1px solod ${borderColor}` }}>
        ...
        <div className='mb-4'>
          ...
          <input type='text' className='w-full border rounded-lg px-3 focus:outline-none  focus:border-orange-500' placeholder='Enter your Full Name' style={{ border: `1px solod ${borderColor}` }} onChange={(e) => setfullName(e.target.value)} value={fullName} />
        </div>
        ...
        <div className='mb-4'>
          ...
          <input type='tel' className='w-full border rounded-lg px-3 focus:outline-none focus:border-orange-500' placeholder='Enter your Mobile Number' style={{ border: `1px solod ${borderColor}` }} onChange={(e) => setMobile(e.target.value)} value={mobile} />
        </div>
        ...
        <div className='mb-4'>
          ...
          <div className='flex gap-2'>
            {["user", "owner", "deliveryBoy"].map((r) => (
              <button className='flex-1 border rounded-lg px-3 py-2 text-center font-medium transition-color cursor-pointer'
                onClick={() => setRole(r)}
        ...
        <button className={`w-full font-semibold py-2 transition duration-200  rounded-lg bg-[#ff4d2d] text-white hover:bg-[#e64323] cursor-pointer`} onClick={handleSignUp } >Sign Up</button>

        <button className={`w-full mt-4 py-2 gap-2 flex items-center justify-center rounded-lg cursor-pointer px-4 text-black border  border-gray-400 hover:bg-gray-200 transition duration-200 `} ><FcGoogle size={20} /><span>Sign up with Google</span></button>
